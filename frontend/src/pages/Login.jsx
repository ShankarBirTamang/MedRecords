...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-page)] text-[var(--text-primary)] flex items-center justify-center p-6 relative overflow-hidden">
      <button
        onClick={toggleTheme}
      ...
      <div className="relative z-10 w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:block px-8">
          ...
          <h1 className="text-5xl font-extrabold leading-tight tracking-tight mb-6">
            ...
            <br />
            belongs to{" "}
            <span className="text-[var(--button-primary)]">you.</span>
          </h1>

          <p className="text-[var(--text-secondary)] text-lg leading-relaxed max-w-lg mb-10">
            Access your medical records securely, control who can view them, and
            verify every record through blockchain technology.
          </p>
          ...
          <div className="space-y-4">
            <div className="card flex items-center gap-4">
              ...
              <div>
                <p className="font-semibold">Patient-controlled access</p>
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="lg:hidden text-center mb-8">
            ...
            <h1 className="text-2xl font-extrabold">MedRecords</h1>
